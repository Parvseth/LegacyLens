        ...
        <div className="absolute inset-[48px] rounded-full bg-[#0a0014]/90 backdrop-blur-xl border border-fuchsia-500/30 shadow-[inset_0_0_80px_rgba(217,70,239,0.2)] flex flex-col items-center justify-center p-8">
          ...
          <div className="text-center mb-8 z-10 flex flex-col items-center">
            ...
            <div className="flex items-center justify-center gap-2 mt-3">
              ...
              <p className="text-[10px] tracking-[0.2em] text-slate-300">AUTHORIZED ACCESS ONLY</p>
              <span className="text-fuchsia-500">«</span>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="w-full max-w-[260px] space-y-5 z-10">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-transparent border border-cyan-400/50 text-white text-sm py-2 px-3 focus:outline-none focus:border-cyan-300 focus:bg-cyan-900/20 transition-colors placeholder:text-slate-600"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-transparent border border-cyan-400/50 text-white text-sm py-2 px-3 focus:outline-none focus:border-cyan-300 focus:bg-cyan-900/20 transition-colors placeholder:text-slate-600 tracking-widest"
                  placeholder="********"
                  disabled={isLoading}
                />
          ...
          <div className="mt-8 z-10 text-[11px] text-slate-400 tracking-wider text-center">
            Don't have an account?{' '}
            <Link to="/register" className="text-fuchsia-400 hover:text-fuchsia-300 transition-colors drop-shadow-[0_0_5px_#d946ef]">
              Create one
            </Link>
          </div>
        </div>
